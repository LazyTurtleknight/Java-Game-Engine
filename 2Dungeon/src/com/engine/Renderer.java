...
public class Renderer{
  ...
  /*
   * Constructor to set up renderer object.
   * 
   * @param gamecon game container object to render to
   */
  ...
  /*
   * Basic function to set a single pixel value.
   * 
   * @param x x coordinate
   * @param y y coordinate
   * @param value (4 byte) int ARGB color where 
   * 1. byte is alpha, 2.byte red, 3. byte green, 4. byte blue
   */
  public void setPixel(int x, int y, int value) {
    ...
    if(alpha == 255) {
      ...
      int newRed   = ((pixelColor >> 16) & 0xff) - (int) ((((pixelColor >> 16) & 0xff) -
          ((value >> 16) & 0xff)) * (alpha / 255f));
      int newGreen = ((pixelColor >>  8) & 0xff) - (int) ((((pixelColor >>  8) & 0xff) -
          ((value >>  8) & 0xff)) * (alpha / 255f));
      int newBlue  =  (pixelColor        & 0xff) - (int) ((( pixelColor        & 0xff) -
  ...
  /*
   * Function to draw a single sprite.
   * 
  ...
  public void drawSprite(Sprite image, int offsetX, int offsetY){
    ...
    if(offsetX < -image.getWidth() || offsetY < -image.getHeight() || offsetX > pixelWidth ||
        offsetY > pixelHeight) {
  ...
  /*
   * Function to draw text in a given color.
   * 
   * @param text string to draw
   * @param offsetX x coordinate
   * @param offsetY y coordinate
   * @param color int indicating color of text
   */
  ...
  /*
   * Function to draw an animation.
   * 
   * @param image sprite animation containing animation to draw
   * @param offsetX x coordinate
   * @param offsetY y coordinate
   * @param spriteId ID of the sprite in the sprite array
   */
  public void drawSpriteAnimation(SpriteAnimation image, int offsetX, int offsetY, int spriteId) {
    //if the image would be outside of the window
    if(offsetX < -image.getSpriteWidth() || offsetY < -image.getSpriteHeight() ||
        offsetX > pixelWidth || offsetY > pixelHeight) {
   ...
   * Function to draw an animation.
   * 
   * @param image sprite animation to draw
   * @param offsetX x coordinate
   * @param offsetY y coordinate
   * @param spriteX x coordinates of the sprite in the grid
   * @param spriteY y coordinates of the sprite in the grid
   */
  ...
  /*
   * Draws vertical or horizontal line.
   * 
   * @param offsetX x coordinate of first endpoint
   * @param offsetY y coordinate of first endpoint
   * @param endpointX x coordinate of second endpoint
   * @param endpointY y coordinate of second endpoint
   * @param color color of rectangle
   */
  ...
  public void drawRectAsSpiral(int offsetX, int offsetY, int width, int height, int borderline, int color) {
    ...
    BiFunction<Integer,Integer,Boolean> condx = (parameter1,parameter2) ->
        {return parameter1<parameter2-1;};
    BiFunction<Integer,Integer,Boolean> condy = (parameter1,parameter2) ->
        {return parameter1<parameter2-1;};   	
